...
class UserEditAboutFragment  : DialogFragment() {
            ...
            user_edit_about?.let {
                ...
                it.addTextChangedListener(object : TextWatcher {
                    ...
                    override fun afterTextChanged(s: Editable) {
                        val charCountString = it.context.getString(R.string.entourage_create_title_char_count_format, s.length, ABOUT_MAX_CHAR_COUNT)
    ...
    companion object {
        ...
        // CONSTANTS
        // ----------------------------------
        val TAG: String? = UserEditAboutFragment::class.java.simpleName
