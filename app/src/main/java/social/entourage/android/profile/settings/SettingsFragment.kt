...
class SettingsFragment : Fragment() {
    ...
    private fun initializeView() {
        ...
        binding.deleteAccount.profileSettingsArrow.visibility = View.GONE
        binding.signOut.profileSettingsArrow.visibility = View.GONE
        ...
        binding.share.profileSettingsArrow.visibility = View.INVISIBLE
        binding.suggest.profileSettingsArrow.visibility = View.INVISIBLE
