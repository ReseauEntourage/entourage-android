...
import social.entourage.android.old_v7.base.HeaderFooterBaseAdapter
...
import social.entourage.android.old_v7.base.newsfeed.announcement.AnnouncementViewHolder
...
class NewsfeedAdapter : HeaderFooterBaseAdapter() {
    ...
    init {
        viewHolderFactory.registerViewHolder(
                ...
                ViewHolderType(
                    FeedItemViewHolderRenew::class.java,
                    FeedItemViewHolderRenew.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
