...
class DiscussionAdapter : BaseAdapter() {
    ...
    init {
        viewHolderFactory.registerViewHolder(
                ...
                ViewHolderType(
                    DateSeparatorViewHolder::class.java,
                    DateSeparatorViewHolder.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
                TimestampedObject.CHAT_MESSAGE_OTHER,
                ViewHolderType(
                    ChatMessageCardViewHolder::class.java,
                    ChatMessageCardViewHolder.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
                TimestampedObject.CHAT_MESSAGE_ME,
                ViewHolderType(
                    ChatMessageMeCardViewHolder::class.java,
                    ChatMessageMeCardViewHolder.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
                TimestampedObject.USER_JOIN,
                ViewHolderType(
                    UserJoinCardViewHolder::class.java,
                    UserJoinCardViewHolder.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
                TimestampedObject.CHAT_MESSAGE_OUTING,
                ViewHolderType(
                    OutingCardViewHolder::class.java,
                    OutingCardViewHolder.layoutResource
                )
        )
        viewHolderFactory.registerViewHolder(
                TimestampedObject.STATUS_UPDATE_CARD,
                ViewHolderType(
                    StatusCardViewHolder::class.java,
                    StatusCardViewHolder.layoutResource
                )
        )
