...
import kotlinx.android.synthetic.main.v7_fragment_create_action_wizard_page3.*
...
class CreateActionWizardPage3Fragment : BaseDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.v7_fragment_create_action_wizard_page3, container, false)
    }
    ...
    companion object {
        ...
        // Attributes
        // ----------------------------------
        val TAG: String? = CreateActionWizardPage3Fragment::class.java.simpleName
