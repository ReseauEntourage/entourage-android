...
import social.entourage.android.old_v7.base.location.LocationFragment
...
import social.entourage.android.old_v7.entourage.create.wizard.CreateActionWizardPage3Fragment
...
class CreateEntourageFragment : BaseDialogFragment(),
    ...
    private fun onEditTitleClicked() {
        val entourageTitleFragment = CreateEntourageTitleFragment.newInstance(
    ...
    private fun onEditDescriptionClicked() {
        val descriptionFragment = CreateEntourageDescriptionFragment.newInstance(
    ...
    private fun onEditPhotoClicked() {
        val photoGallery =
            CreateEntouragePhotoGalleryFragment.newInstance(portrait_photo_url, landscape_photo_url)
    ...
    private fun initializePrivacyAction() {
        if (BaseEntourage.GROUPTYPE_OUTING.equals(groupType, ignoreCase = true)) {
            ...
            ui_layout_privacyAction_public?.setOnClickListener {
                val entourageTitleFragment =
                    CreateEntouragePrivacyActionFragment.newInstance(isPublic)
                entourageTitleFragment.setListener(this)
                entourageTitleFragment.show(parentFragmentManager, CreateEntourageTitleFragment.TAG)
            }
        }
