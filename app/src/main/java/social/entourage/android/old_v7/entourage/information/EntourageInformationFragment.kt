...
import social.entourage.android.old_v7.entourage.EntourageCloseFragment
...
class EntourageInformationFragment : FeedItemInformationFragment() {
    ...
    private fun onReportEntourageButton() {
        ...
        EntourageReportFragment.newInstance(feedItem.id.toInt(),(feedItem is EntourageEvent)).show(parentFragmentManager,
            EntourageReportFragment.TAG)
    }
