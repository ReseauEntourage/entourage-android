            ...
            when (getItemViewType(position)) {
                ...
                TYPE_POST -> {
                    ...
                    with(postsList[position]) {
                        ...
                        if(DataLanguageStock.userLanguage == this.contentTranslationsHtml?.fromLang || (this.user?.id == meId?.toLong()) && (this.content == "")){
                        ...
                        if(this.contentTranslationsHtml == null ){
                            binding.postTranslationButton.layoutCsTranslate.visibility = View.GONE
                        }
                        ...
                        var contentToShow = contentHtml
                        if (contentTranslationsHtml != null) {
                            contentToShow = if (isTranslated) contentTranslationsHtml.translation else contentTranslationsHtml.original
                        }
                        ...
                        if(status == "deleted"){
                            ...
                            if(contentTranslationsHtml != null){
                                if(isTranslated){
                                    contentToShow = contentTranslationsHtml.original
                                }else{
                                    contentToShow = contentTranslationsHtml.translation
                                }
                            }
                            binding.postMessage.text = contentToShow
                            binding.postMessage.displayHtml(contentToShow?: "")
