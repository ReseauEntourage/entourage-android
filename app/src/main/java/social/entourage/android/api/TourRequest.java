...
public interface TourRequest {
    ...
    @GET("/tours/{id}.json")
    void tourRetrieve( @Path("id") long tourId, Callback<TourWrapper> callback);

    @PUT("/tours/{id}.json")
    void tourClose( @Path("id") long tourId, @Body TourWrapper tourWrapper, Callback<TourWrapper> callback);
