...
class TourFilterFragment  : BaseMapFilterFragment() {
    ...
    override fun saveFilter() {
        TourFilter.tourTypeMedical = map_filter_tour_medical_switch.isChecked
        TourFilter.tourTypeSocial = map_filter_tour_social_switch.isChecked
        TourFilter.tourTypeDistributive = map_filter_tour_distributive_switch.isChecked
        TourFilter.timeframe = when {
            map_filter_time_days_1.isChecked -> TourFilter.DAYS_1
            map_filter_time_days_2.isChecked -> TourFilter.DAYS_2
            map_filter_time_days_3.isChecked -> TourFilter.DAYS_3
