...
internal object CountryList {
    ...
    fun getAllCountries(context: Context): List<Country>? {
        ...
        newCountries.add(
            Country(context.getString(R.string.country_mauritania_code),
                context.getString(R.string.country_mauritania_number),
                context.getString(R.string.country_mauritania_name))
        )
        newCountries.add(
            Country(context.getString(R.string.country_mauritius_code),
        ...
        newCountries.add(
            Country(context.getString(R.string.country_syrian_arab_republic_code),
