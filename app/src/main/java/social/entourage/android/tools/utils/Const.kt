...
object Const {
    ...
    const val IS_NOT_TRANSLATABLE = "is_not_translatable"
    const val IS_MY_LANGUAGE = "is_my_language"
    const val CONTENT_COPIED = "content_copied"
    ...
    const val READ_CONNECT_WRITE_TIMEOUT:Long = 15
