...
// New Analytics Events
    ...
    const val Action__CreateGroupStepThreeFragment__egs3AddPhoto = "Action__CreateGroupStepThreeFragment__egs3AddPhoto"
    const val View__CreateGroupStepOneFragment = "View__CreateGroupStepOneFragment"
    const val Action__CreateGroupStepOneFragment__groupLocation = "Action__CreateGroupStepOneFragment__groupLocation"
    const val View__ChooseGalleryPhotoModalFragment = "View__ChooseGalleryPhotoModalFragment"
    const val Action__ChooseGalleryPhotoModalFragment__hbsIconCross = "Action__ChooseGalleryPhotoModalFragment__hbsIconCross"
    const val View__GroupDetailsFragment = "View__GroupDetailsFragment"
    const val Action__GroupDetailsFragment__hbsIconCross = "Action__GroupDetailsFragment__hbsIconCross"
    const val Action__GroupDetailsFragment__report = "Action__GroupDetailsFragment__report"
    const val View__AboutGroupFragment = "View__AboutGroupFragment"
    const val Action__AboutGroupFragment__headerIconSettings = "Action__AboutGroupFragment__headerIconSettings"
    const val Action__AboutGroupFragment__headerIconBack = "Action__AboutGroupFragment__headerIconBack"
    const val Action__AboutGroupFragment__join = "Action__AboutGroupFragment__join"
    ...
    const val Action__EditGroupFragment__egs3AddPhoto = "Action__EditGroupFragment__egs3AddPhoto"
    const val Action__EditGroupFragment__iconBack = "Action__EditGroupFragment__iconBack"
    const val Action__EditGroupFragment__button = "Action__EditGroupFragment__button"
    const val Action__MyGroupsListFragment__button = "Action__MyGroupsListFragment__button"
    const val View__PartnerFragment = "View__PartnerFragment"
    const val Action__PartnerFragment__titleCloseButton = "Action__PartnerFragment__titleCloseButton"
    const val Action__PartnerFragment__uiButtonAssoAddress = "Action__PartnerFragment__uiButtonAssoAddress"
    const val Action__PartnerFragment__uiButtonAssoMail = "Action__PartnerFragment__uiButtonAssoMail"
    const val Action__PartnerFragment__uiButtonAssoPhone = "Action__PartnerFragment__uiButtonAssoPhone"
    const val Action__PartnerFragment__uiButtonAssoWeb = "Action__PartnerFragment__uiButtonAssoWeb"
    const val Action__PartnerFragment__uiButtonFollow = "Action__PartnerFragment__uiButtonFollow"
    const val View__UserEditPartnerFragment = "View__UserEditPartnerFragment"
    const val Action__UserEditPartnerFragment__titleCloseButton = "Action__UserEditPartnerFragment__titleCloseButton"
    const val Action__UserEditPartnerFragment__titleActionButton = "Action__UserEditPartnerFragment__titleActionButton"
    const val View__UserActionPlaceFragment = "View__UserActionPlaceFragment"
    const val Action__UserActionPlaceFragment__uiOnboardBtLocation = "Action__UserActionPlaceFragment__uiOnboardBtLocation"
    const val Action__UserActionPlaceFragment__uiOnboardPlaceTvLocation = "Action__UserActionPlaceFragment__uiOnboardPlaceTvLocation"
    const val View__UserEditActionZoneFragment = "View__UserEditActionZoneFragment"
    const val Action__UserEditActionZoneFragment__titleActionButton = "Action__UserEditActionZoneFragment__titleActionButton"
    const val Action__UserEditActionZoneFragment__titleCloseButton = "Action__UserEditActionZoneFragment__titleCloseButton"
    const val View__EditPhotoFragment = "View__EditPhotoFragment"
    const val Action__HomeFragment__chatbotButton = "Action__HomeFragment__chatbotButton"
    const val Action__HomeFragment__button = "Action__HomeFragment__button"
    const val View__EventConfirmationEventFragment = "View__EventConfirmationEventFragment"
    const val Action__EventConfirmationEventFragment__validateBtn = "Action__EventConfirmationEventFragment__validateBtn"
    const val Action__EventConfirmationEventFragment__cancelButton = "Action__EventConfirmationEventFragment__cancelButton"
    const val Action__EventConfirmationEventFragment__closeButton = "Action__EventConfirmationEventFragment__closeButton"
    const val View__DiscussionTestDialogFragment = "View__DiscussionTestDialogFragment"
    const val View__HomeCongratPopFragment = "View__HomeCongratPopFragment"
    const val Action__HomeCongratPopFragment__uiPopClose = "Action__HomeCongratPopFragment__uiPopClose"
    const val View__PedagoListFragment = "View__PedagoListFragment"
    const val Action__PedagoListFragment__headerIconBack = "Action__PedagoListFragment__headerIconBack"
    const val View__PedagoContentDetailsFragment = "View__PedagoContentDetailsFragment"
    const val Action__PedagoContentDetailsFragment__headerIconBack = "Action__PedagoContentDetailsFragment__headerIconBack"
    const val View__TranslationBottomFragment = "View__TranslationBottomFragment"
    const val Action__TranslationBottomFragment__validate = "Action__TranslationBottomFragment__validate"
    const val Action__TranslationBottomFragment__iconCross = "Action__TranslationBottomFragment__iconCross"
    const val View__OnboardingActionWishesFragment = "View__OnboardingActionWishesFragment"
    const val View__OnboardingCategorieFragment = "View__OnboardingCategorieFragment"
    const val View__OnboardingInterestFragment = "View__OnboardingInterestFragment"
    const val View__EnhancedOnboardingAssoFragment = "View__EnhancedOnboardingAssoFragment"
    const val Action__EnhancedOnboardingAssoFragment__ivLogo = "Action__EnhancedOnboardingAssoFragment__ivLogo"
    const val Action__EnhancedOnboardingAssoFragment__btnUploadLogo = "Action__EnhancedOnboardingAssoFragment__btnUploadLogo"
    const val View__OnboardingCongratsFragment = "View__OnboardingCongratsFragment"
    const val View__OnboardingPresentationFragment = "View__OnboardingPresentationFragment"
    const val View__OnboardingDisponibilityFragment = "View__OnboardingDisponibilityFragment"
    const val View__GuideMapFragment = "View__GuideMapFragment"
    const val Action__GuideMapFragment__fragmentGuideAlertArrow = "Action__GuideMapFragment__fragmentGuideAlertArrow"
    const val Action__GuideMapFragment__fragmentGuideAlert = "Action__GuideMapFragment__fragmentGuideAlert"
    const val Action__GuideMapFragment__fragmentGuideEmptyListPopup = "Action__GuideMapFragment__fragmentGuideEmptyListPopup"
    const val Action__GuideMapFragment__fragmentGuideInfoPopupClose = "Action__GuideMapFragment__fragmentGuideInfoPopupClose"
    const val Action__GuideMapFragment__fragmentGuideInfoPopup = "Action__GuideMapFragment__fragmentGuideInfoPopup"
    const val Action__GuideMapFragment__fragmentGuideDisplayToggle = "Action__GuideMapFragment__fragmentGuideDisplayToggle"
    const val Action__GuideMapFragment__buttonGuideHelp = "Action__GuideMapFragment__buttonGuideHelp"
    const val Action__GuideMapFragment__it = "Action__GuideMapFragment__it"
    const val View__GDSSearchFragment = "View__GDSSearchFragment"
    const val View__GuideHubFragment = "View__GuideHubFragment"
    const val View__GuideFilterFragment = "View__GuideFilterFragment"
    const val Action__GuideFilterFragment__titleCloseButton = "Action__GuideFilterFragment__titleCloseButton"
    const val Action__GuideFilterFragment__bottomActionButton = "Action__GuideFilterFragment__bottomActionButton"
    const val Action__GuideFilterFragment__uiBtCancel = "Action__GuideFilterFragment__uiBtCancel"
    const val View__ReadPoiFragment = "View__ReadPoiFragment"
    ...
    const val Action__ReadPoiFragment__uiBtShareOutside = "Action__ReadPoiFragment__uiBtShareOutside"
    const val Action__ReadPoiFragment__uiLayoutFullHelpInfo = "Action__ReadPoiFragment__uiLayoutFullHelpInfo"
    const val View__PoiListFragment = "View__PoiListFragment"
    const val Action__EventsFragment__overlayView = "Action__EventsFragment__overlayView"
    const val Action__EventsFragment__bubbleView = "Action__EventsFragment__bubbleView"
    const val Action__EventsFragment__uiLayoutFilter = "Action__EventsFragment__uiLayoutFilter"
    const val View__CreateEventActionZoneFragment = "View__CreateEventActionZoneFragment"
    const val Action__CreateEventActionZoneFragment__titleActionButton = "Action__CreateEventActionZoneFragment__titleActionButton"
    const val Action__CreateEventActionZoneFragment__titleCloseButton = "Action__CreateEventActionZoneFragment__titleCloseButton"
    const val View__CreateEventStepThreeFragment = "View__CreateEventStepThreeFragment"
    const val Action__CreateEventStepThreeFragment__location = "Action__CreateEventStepThreeFragment__location"
    const val View__CreateEventSuccessFragment = "View__CreateEventSuccessFragment"
    const val Action__CreateEventSuccessFragment__seeEvent = "Action__CreateEventSuccessFragment__seeEvent"
    const val View__CreateEventStepOneFragment = "View__CreateEventStepOneFragment"
    const val Action__CreateEventStepOneFragment__addPhotoLayout = "Action__CreateEventStepOneFragment__addPhotoLayout"
    const val Action__CreateEventStepOneFragment__addPhoto = "Action__CreateEventStepOneFragment__addPhoto"
    const val View__CreateEventStepFourFragment = "View__CreateEventStepFourFragment"
    const val View__CreateEventStepFiveFragment = "View__CreateEventStepFiveFragment"
    const val View__CreateEventStepTwoFragment = "View__CreateEventStepTwoFragment"
    const val View__CreateEventFragment = "View__CreateEventFragment"
    const val Action__CreateEventFragment__next = "Action__CreateEventFragment__next"
    const val Action__CreateEventFragment__iconBack = "Action__CreateEventFragment__iconBack"
    ...
    const val Action__AboutEventFragment__headerIconBack = "Action__AboutEventFragment__headerIconBack"
    const val Action__AboutEventFragment__join = "Action__AboutEventFragment__join"
    const val Action__AboutEventFragment__calendar = "Action__AboutEventFragment__calendar"
    const val View__GroupEventsListFragment = "View__GroupEventsListFragment"
    const val Action__GroupEventsListFragment__iconBack = "Action__GroupEventsListFragment__iconBack"
    const val Action__GroupEventsListFragment__createEvent = "Action__GroupEventsListFragment__createEvent"
    const val View__MyEventsListFragment = "View__MyEventsListFragment"
    ...
    const val View__AcceptPhotoDialogFragment = "View__AcceptPhotoDialogFragment"
    const val Action__AcceptPhotoDialogFragment__btnDecline = "Action__AcceptPhotoDialogFragment__btnDecline"
    const val Action__AcceptPhotoDialogFragment__btnAccept = "Action__AcceptPhotoDialogFragment__btnAccept"
    const val View__ReportModalFragment = "View__ReportModalFragment"
    const val Action__ReportModalFragment__layoutChooseSignal = "Action__ReportModalFragment__layoutChooseSignal"
    const val Action__ReportModalFragment__layoutChooseTranslate = "Action__ReportModalFragment__layoutChooseTranslate"
    const val Action__ReportModalFragment__next = "Action__ReportModalFragment__next"
    const val Action__ReportModalFragment__back = "Action__ReportModalFragment__back"
    const val Action__ReportModalFragment__send = "Action__ReportModalFragment__send"
    const val Action__ReportModalFragment__hbsIconCross = "Action__ReportModalFragment__hbsIconCross"
    ...
    const val Action__AssociationProfileFragment__assoProfileIconBack = "Action__AssociationProfileFragment__assoProfileIconBack"
    const val Action__AssociationProfileFragment__button = "Action__AssociationProfileFragment__button"
    const val Action__EditPasswordFragment__iconBack = "Action__EditPasswordFragment__iconBack"
    const val Action__EditPasswordFragment__buttonValidate = "Action__EditPasswordFragment__buttonValidate"
    const val View__ShareMessageFragment = "View__ShareMessageFragment"
    const val Action__ShareMessageFragment__titleCloseButton = "Action__ShareMessageFragment__titleCloseButton"
    const val View__WebViewFragment = "View__WebViewFragment"
    const val Action__WebViewFragment__webviewBackButton = "Action__WebViewFragment__webviewBackButton"
    const val Action__WebViewFragment__webviewMoreButton = "Action__WebViewFragment__webviewMoreButton"
    const val Action__WebViewFragment__webviewBackground = "Action__WebViewFragment__webviewBackground"
    const val Action__WebViewFragment__webviewMenuBrowser = "Action__WebViewFragment__webviewMenuBrowser"
    const val Action__WebViewFragment__webviewMenuCopy = "Action__WebViewFragment__webviewMenuCopy"
    const val Action__WebViewFragment__webviewMenuShare = "Action__WebViewFragment__webviewMenuShare"
    const val Action__WebViewFragment__webviewNavigationBarMenuBackground = "Action__WebViewFragment__webviewNavigationBarMenuBackground"
    const val View__ImageDialogFragment = "View__ImageDialogFragment"
    const val View__InAppNotificationListFragment = "View__InAppNotificationListFragment"
    const val Action__InAppNotificationListFragment__iconBack = "Action__InAppNotificationListFragment__iconBack"
    const val View__ActionsFragment = "View__ActionsFragment"
    const val Action__ActionsFragment__uiLayoutFilter = "Action__ActionsFragment__uiLayoutFilter"
    const val View__ActionDetailFragment = "View__ActionDetailFragment"
    const val Action__ActionDetailFragment__tvButtonTranslate = "Action__ActionDetailFragment__tvButtonTranslate"
    const val Action__ActionDetailFragment__titleSignal = "Action__ActionDetailFragment__titleSignal"
    const val Action__ActionDetailFragment__uiLayoutCharte = "Action__ActionDetailFragment__uiLayoutCharte"
    const val Action__ActionDetailFragment__layoutUser = "Action__ActionDetailFragment__layoutUser"
    const val Action__ActionDetailFragment__uiBtModify = "Action__ActionDetailFragment__uiBtModify"
    const val Action__ActionDetailFragment__uiBtDelete = "Action__ActionDetailFragment__uiBtDelete"
    const val Action__ActionDetailFragment__uiBtBackEmpty = "Action__ActionDetailFragment__uiBtBackEmpty"
    const val View__CreateActionPlaceFragment = "View__CreateActionPlaceFragment"
    const val Action__CreateActionPlaceFragment__titleActionButton = "Action__CreateActionPlaceFragment__titleActionButton"
    const val Action__CreateActionPlaceFragment__titleCloseButton = "Action__CreateActionPlaceFragment__titleCloseButton"
    const val View__CreateActionCGUFragment = "View__CreateActionCGUFragment"
    const val Action__CreateActionCGUFragment__accept = "Action__CreateActionCGUFragment__accept"
    const val Action__CreateActionCGUFragment__iconBack = "Action__CreateActionCGUFragment__iconBack"
    const val View__CreateActionFragment = "View__CreateActionFragment"
    const val Action__CreateActionFragment__iconBack = "Action__CreateActionFragment__iconBack"
    const val Action__CreateActionFragment__previous = "Action__CreateActionFragment__previous"
    const val Action__CreateActionFragment__next = "Action__CreateActionFragment__next"
    const val View__CreateActionSuccessFragment = "View__CreateActionSuccessFragment"
    const val Action__CreateActionSuccessFragment__post = "Action__CreateActionSuccessFragment__post"
    const val View__CreateActionStepLocationFragment = "View__CreateActionStepLocationFragment"
    const val Action__CreateActionStepLocationFragment__groupLocation = "Action__CreateActionStepLocationFragment__groupLocation"
    const val View__CreateActionStepFourFragment = "View__CreateActionStepFourFragment"
    const val Action__CreateActionStepFourFragment__btnYes = "Action__CreateActionStepFourFragment__btnYes"
    const val Action__CreateActionStepFourFragment__btnNo = "Action__CreateActionStepFourFragment__btnNo"
    const val View__CreateActionStepCategoryFragment = "View__CreateActionStepCategoryFragment"
    const val View__CreateActionStepDescriptionFragment = "View__CreateActionStepDescriptionFragment"
    const val Action__CreateActionStepDescriptionFragment__addPhotoLayout = "Action__CreateActionStepDescriptionFragment__addPhotoLayout"
    const val Action__CreateActionStepDescriptionFragment__uiLayoutAddPhoto = "Action__CreateActionStepDescriptionFragment__uiLayoutAddPhoto"
    const val View__ActionListFragment = "View__ActionListFragment"
    const val View__MyActionsListFragment = "View__MyActionsListFragment"
    const val View__OnboardingPhase3Fragment = "View__OnboardingPhase3Fragment"
    const val View__OnboardingPhase1Fragment = "View__OnboardingPhase1Fragment"
    const val View__OnboardingPhotoFragment = "View__OnboardingPhotoFragment"
    const val View__OnboardingAddPlaceFragment = "View__OnboardingAddPlaceFragment"
    const val Action__OnboardingAddPlaceFragment__titleActionButton = "Action__OnboardingAddPlaceFragment__titleActionButton"
    const val View__OnboardingPhase2Fragment = "View__OnboardingPhase2Fragment"
    const val Action__OnboardingPhase2Fragment__tvRetryLink = "Action__OnboardingPhase2Fragment__tvRetryLink"
    const val Action__OnboardingPhase2Fragment__uiOnboardBtHelp = "Action__OnboardingPhase2Fragment__uiOnboardBtHelp"
    const val Action__OnboardingPhase2Fragment__uiOnboardCodeTvPhoneMod = "Action__OnboardingPhase2Fragment__uiOnboardCodeTvPhoneMod"
    const val View__OnboardingEditPhotoFragment = "View__OnboardingEditPhotoFragment"
